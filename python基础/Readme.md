...
| 仓库                                                         | 简介 + 内容                                                  | 优点                                                         | 缺点 / 局限                                                  |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Devinterview-io / python-interview-questions** ([GitHub](https://github.com/Devinterview-io/python-interview-questions?utm_source=chatgpt.com)) | 面试常见 Python 问题 + 回答合集（基础 + 中级）               | 内容全面，有基础知识点 + 举例，格式清晰                      | 少量代码练习，偏问答式，不一定每题都含深度算法或实践场景     |
| **kiransagar1 / 300-python-Interview-questions-and-solutions** ([GitHub](https://github.com/kiransagar1/300-python-Interview-questions-and-solutions?utm_source=chatgpt.com)) | 收集了 300 个 Python 问题 + 解答／思路                       | 数量大，覆盖面广，是练习“题海”不错的资源                     | 部分题目可能偏基础或重复；解答质量参差不齐，需要自己挑＋验证 |
| **baliyanvinay / Python‐Interview‐Preparation** ([GitHub](https://github.com/baliyanvinay/Python-Interview-Preparation?utm_source=chatgpt.com)) | 涵盖 Python 基础概念（对象、可变不可变、特殊方法等）＋一些小练习脚本 | 非常适合加深对 Python “基础/语言机制” 的理解；有代码示例；容易入门 | 对算法 /大规模系统的实战题少；题目难度中等偏低               |
| **liyin2015 / python-coding-interview** ([GitHub](https://github.com/liyin2015/python-coding-interview?utm_source=chatgpt.com)) | 算法书 + coding 面试准备，包含很多 LeetCode 风格问题 + 模式 + 原理 | 深度好，结构体系强，有 “题型模式 + 原理 + 练习” 结合；适合系统性提升 | 库较大；如果基础还不够扎实，可能开始阶段会有点吃力           |
| **siddhu1919 / Top-20-Python-Coding-Interview-Question** ([GitHub](https://github.com/siddhu1919/Top-20-Python-Coding-Interview-Question?utm_source=chatgpt.com)) | 20 道 Python 面试经典题目 + 代码答题示例                     | 题量少但精（适合快复习 +模拟面试）；可以快速做一轮温习       | 深度不够；算法型题目 /极端场景题少；偏“基础 + 常见问法”      |
